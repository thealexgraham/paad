...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00010309;
#if WIN64
    ...
    */
    public enum OUTPUTTYPE : int
    {
        ...
        WASAPI,          /* Win             - Windows Audio Session API.                (Default on Windows Vista and above) */
        ...
        AUDIOOUT,        /* PS4/PSVita      - Audio Out output.                         (Default on PS4 and PS Vita) */
...
#pragma warning restore 414
    ...
    */
    public class System : HandleBase
    {
        ...
        public RESULT setCallback            (SYSTEM_CALLBACK callback, SYSTEM_CALLBACKTYPE callbacktype)
        {
            return FMOD_System_SetCallback(rawPtr, callback, callbacktype);
        }
        ...
        */
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_System_SetCallback            (IntPtr system, SYSTEM_CALLBACK callback, SYSTEM_CALLBACKTYPE callbacktype);
        [DllImport(VERSION.dll)]
    ...
    */
    public class Sound : HandleBase
    {
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_Sound_GetDefaults             (IntPtr sound, out float frequency, out float volume, out float pan, out int priority);
        [DllImport(VERSION.dll)]
    ...
    */
    public class ChannelControl : HandleBase
    {
        ...
        public RESULT addDSP(DSP dsp)
        {
            ...
            return addDSP(dsp, CHANNELCONTROL_DSP_INDEX.HEAD, out temp);
        }
        ...
        [DllImport(VERSION.dll)]
        private static extern RESULT FMOD_ChannelGroup_AddDSP(IntPtr channelgroup, int index, IntPtr dsp, out IntPtr connection);
        [DllImport(VERSION.dll)]
