...
FMOD_RESULT F_CALLBACK FMOD_Other_dspprocess      (FMOD_DSP_STATE *dsp_state, unsigned int length, const FMOD_DSP_BUFFER_ARRAY *inbufferarray, FMOD_DSP_BUFFER_ARRAY *outbufferarray, FMOD_BOOL inputsidle, FMOD_DSP_PROCESS_OPERATION op);
...
void FMODOtherState::generate(float *outbuffer, unsigned int length, int channels)
{
	sendMsg("/process", 1);
}
...
FMOD_RESULT F_CALLBACK FMOD_Noise_dspprocess(FMOD_DSP_STATE *dsp_state, unsigned int length, const FMOD_DSP_BUFFER_ARRAY *inbufferarray, FMOD_DSP_BUFFER_ARRAY *outbufferarray, FMOD_BOOL inputsidle, FMOD_DSP_PROCESS_OPERATION op)
{
    FMODOtherState *state = (FMODOtherState *)dsp_state->plugindata;
    state->generate(outbufferarray->buffers[0], length, outbufferarray->buffernumchannels[0]); // input and output channels count match for this effect
    return FMOD_OK;
}
