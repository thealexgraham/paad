...
import net.alexgraham.thesis.supercollider.synths.TaskPlayer.PlayState;
...
public class TaskPlayerModule extends ModulePanel implements TaskListener {
	...
	public TaskPlayerModule(TaskPlayer runner) {
		super();
	...
	public void setupPanels(ConnectablePanel topPanel,
		...
		topPanel.addConnector(Location.TOP, player.getConnector(ConnectorType.ACTION_OUT), this);
...
//		parametersPanel.setLayout(new GridLayout(0, 1, 5, 5));
		...
		bottomPanel.addConnector(Location.BOTTOM, player.getConnector(ConnectorType.ACTION_OUT), this);
	}
	...
	public JPanel createButtonPanel(JButton button, String action) {
		JPanel panel = ModuleFactory.createSideConnectPanel(this, player.getConnector(ConnectorType.ACTION_IN, action.toLowerCase()), button);
		return panel;
	...
	public void setupPanelsOld(ConnectablePanel topPanel,
		...
		topContent = ModuleFactory.createSideConnectPanel(this, player.getConnector(ConnectorType.ACTION_OUT), topContent);
